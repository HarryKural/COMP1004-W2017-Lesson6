...
namespace COMP1004_W2017_Lesson6
{
    public partial class CalculatorForm : Form
    {
        ...
        private void optionsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            // Step 2. Set a reference to the "PreviousForm" property of the Option Form to this form
            optionsForm.PreviousForm = this;

            optionsForm.CalculatorLayout = this.CalculatorFormLayout;

            // Step 3. Show the Options Form with Show Dialog (a model method to display the form)
